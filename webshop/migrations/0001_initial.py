    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metal_type', models.CharField(choices=[('RVS Goud', 'RVS Goud'), ('RVS Zilver', 'RVS Zilver'), ('Gold plated', 'Gold plated'), ('Silver plated', 'Silver plated')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jewelry_type', models.CharField(choices=[('Armband', 'Armband'), ('Ketting', 'Ketting'), ('Oorbel', 'Oorbel'), ('Hanger', 'Hanger')], max_length=30)),
                ...
                ('color', models.ManyToManyField(blank=True, to='webshop.Color')),
